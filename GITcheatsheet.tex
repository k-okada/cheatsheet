...
\begin{tabbing}
Ub\=untu 14.04 or newer users use \href{http://golang.org/doc/install}{Go development
...
Ub\=untu 12.04 users use rubygem to install.\\
\> \texttt{\$ sudo apt-get install rubygems git-core}\\
